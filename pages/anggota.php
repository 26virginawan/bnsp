...
<div id="content">
    <p id="tombol-tambah-container">
        ...
        <a style="margin-right:15px; margin-left: 20px;" target="_blank" href="pages/cetak.php"><img src="print.png"
                height="50px" height="50"></a>
        <a style="margin-right:15px;" target="_blank" href="ekpor_pdf.php"><img src="pdf.png" height="50px"
                height="50"></a>
        <a target="_blank" href="ekpor_excel.php"><img src="excel.png" height="50px" height="50"></a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="tombol-opsi-container"><a href="proses/anggota-hapus.php?id=<?php echo $r_tampil_anggota[
                        'idanggota'
                    ]; ?>" class="tombol"
