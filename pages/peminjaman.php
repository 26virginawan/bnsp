...
<div id="content">
    <p id="tombol-tambah-container">
        <a href="index.php?p=peminjaman-input" class="tombol">
            Tambah Transaksi
        </a>
        <a style="margin-left:15px;" target="_blank" href="ekpor_peminjaman.php"><img src="pdf.png" height="50px"
                height="50"></a>
    ...
    <table id="tabel-tampil">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="tombol-opsi-container"><a href="proses/peminjaman-hapus.php?id=<?php echo $r_tampil_pinjam[
                        'id_peminjaman'
                    ]; ?>" class="tombol"
