<div id="label-page">
    <h3>Tampil Transaksi Pengembalian</h3>
</div>
<div id="content">
    <p id="tombol-tambah-container">
        <a href="index.php?p=pengembalian-input" class="tombol">
            Tambah Pengembalian
        </a>
        <a style="margin-left:15px;" target="_blank" href="ekpor_pengembalian.php"><img src="pdf.png" height="50px"
                height="50"></a>
    ...
    <table id="tabel-tampil">
        ...
        <tbody>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($pencarian != '') {
                    $sql = "SELECT * FROM tbpengembalian WHERE judul_buku LIKE '%$pencarian%'";

                    $query = $sql;
                    $queryJml = $sql;
                } else {
                    $query = "SELECT * FROM tbpengembalian LIMIT $posisi, $batas";
                    $queryJml = 'SELECT * FROM tbpengembalian';
                    $no = $posisi * 1;
                }
            } else {
                $query = "SELECT * FROM tbpengembalian LIMIT $posisi, $batas";
            ...
            <tr>
                ...
                <td><?php echo $r_tampil_pinjam['id_pengembalian']; ?></td>
                <td><?php echo $r_tampil_pinjam['nama']; ?></td>
                <td><?php echo $r_tampil_pinjam['judul_buku']; ?></td>
                <td><?php echo $r_tampil_pinjam['tgl_kembali']; ?></td>
                <td>
                    <div class="tombol-opsi-container"><a href="proses/pengembalian-hapus.php?id=<?php echo $r_tampil_pinjam[
                        'id_pengembalian'
                    ]; ?>" class="tombol"
